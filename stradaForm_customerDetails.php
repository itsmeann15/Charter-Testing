...
$sql = "INSERT INTO strada_form (car_model, first_name, last_name, phone, email, addr, date_start, date_end, numDays) VALUES ('$car_model','$first_name', '$last_name', '$phone', '$email', '$addr', '$date_start', '$date_end', '$numDays')";
