...
<table class="table">
    ...
    <tbody> 
        ...
        ?>
                    ...
                    <td><a class="btn btn-info" href="stradaForm_update.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="stradaForm_delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
